(() => {
  ...
  var main = function __do() {
    ...
    if (mContainer instanceof Nothing) {
      return log("Could not find app element")();
    }
    ;
    if (mContainer instanceof Just) {
      ...
      return log("HTML elements added to the page")();
    }
    ;
    throw new Error("Failed pattern match at Main (line 24, column 3 - line 39, column 44): " + [mContainer.constructor.name]);
  };
